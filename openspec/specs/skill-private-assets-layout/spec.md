...
Define the dependency boundary for public wiki skills in the repository. This spec distinguishes skill-private assets from wiki runtime contract and wiki instance data, and it defines which supporting files must live under the owning `skill/<name>/` directory.
